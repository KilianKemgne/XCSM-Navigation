                ...
                if(notion.getAttribute('position') == Position){
                    fetch('../'+notion.id+'.xml').then((response) => {
                        ...
                        response.text().then((xml) => {
                            ...
                            nav_bar_details = "<ol class='breadcrumb breadcrumb-style1 my-2' id='nav-list-details'><li class='breadcrumb-item'><a href='index.html'>XCSM</a></li><li class='breadcrumb-item'><a href='index.html'>Edition</a></li>"+
